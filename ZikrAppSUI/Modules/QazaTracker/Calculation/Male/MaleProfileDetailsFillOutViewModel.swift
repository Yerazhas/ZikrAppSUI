//
//  MaleProfileDetailsFillOutViewModel.swift
//  ZikrAppSUI
//
...
final class MaleProfileDetailsFillOutViewModel: ProfileDetailsFillOutViewModelProtocol {
    @Published var isMajorityDateUnknown = false {
        didSet {
            handleIsMajorityDateUnknown(isMajorityDateUnknown)
        }
    }
    ...
    func calculateQazaPrayersAmount() {
        ...
        let dateComponents = calendar.dateComponents([.day], from: majorityDate!, to: prayerStartDate)
        guard let differenceInDays = dateComponents.day else { return }
        let qazaPrayersCount = differenceInDays
    ...
    private func handleIsMajorityDateUnknown(_ isMajorityDateUnknown: Bool) {
...
extension MaleProfileDetailsFillOutViewModel: Hapticable {}
